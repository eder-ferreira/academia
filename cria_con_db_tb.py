...
with con:
    ...
    cur.execute('''INSERT INTO tb_usuario(usuario, senha, nome, email, tipo_documento, num_documento, status, dt_nascimento,  dt_cadastro)VALUES('loren','loren','Loren Pires','loren@loren.com','CPF',00134123456,'Inativo','2007-01-24','2022-11-01')''')
    ...
    cur.execute('''INSERT INTO tb_usuario(usuario, senha, nome, email, tipo_documento, num_documento, status, dt_nascimento,  dt_cadastro)VALUES('luvpof','lu123','Luciana Ferreira','lu@gmail.com','CPF',00103655632,'Ativo','1979-09-25','2000-02-01')''')
    ...
    cur.execute('''INSERT INTO tb_usuario(usuario, senha, nome, email, tipo_documento, num_documento, status, dt_nascimento,  dt_cadastro)VALUES('alice2005','al2023','Alice Ortega','ortega@alice.com','RG',001022987,'Ativo','1988-01-20','2023-01-01')''')
