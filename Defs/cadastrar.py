...
def cadastrar_aluno():
    ...
    cur.execute(
        "INSERT INTO tb_aluno(id, matricula, nome, tipo_documento, num_documento, telefone, "
...
def cadastrar_funcionario():
    ...
    funcionario = Funcionario(
        ...
        dt_desligamento=data_desligamento,
        cargo_id=cargo_id,
        dt_cadastro=data_cadastro,
    )

    cur.execute(
        "INSERT INTO tb_funcionario(id, nome, tipo_documento, num_documento, "
...
def cadastrar_cargo():
    ...
    cur.execute(
        "INSERT INTO tb_cargo(id, codigo, nome, setor, salario_base, dt_cadastro)VALUES(null,?,?,?,?,?)",
...
def cadastrar_plano():
    ...
    cur.execute(
        "INSERT INTO tb_plano(id, codigo, descricao, nivel, valor, status, dt_cadastro)VALUES(null,?,?,?,?,?,?)",
        (
            plano.codigo,
            plano.descricao,
            plano.nivel,
...
def cadastrar_endereco():
    ...
    cur.execute(
        "INSERT INTO tb_endereco(id, rua, numero, complemento, cep, bairro, cidade, estado)VALUES(null,?,?,?,?,?,?,?,?)",
        (
            endereco.matricula,
            endereco.nome,
            endereco.rua,
...
def cadastrar_usuario():
    ...
    cur.execute(
        "INSERT INTO tb_usuario(id, matricula, usuario, senha, nome, email, tipo_documento, num_documento, "
    ...
    cur.execute(
        "INSERT INTO tb_aluno(matricula, nome, tipo_documento, num_documento, dt_nascimento, "
