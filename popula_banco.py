...
with con:
    ...
    cur.execute('''INSERT INTO tb_usuario(matricula,usuario, senha, nome, email, tipo_documento, num_documento, status, dt_nascimento, dt_cadastro)VALUES('0123463','toniamachado','272ton','Antonia Machado','tonia@gmail.com','CPF',00134123460,'Inativo','2001-12-05','2023-02-01')''')
    cur.execute('''INSERT INTO tb_usuario(matricula,usuario, senha, nome, email, tipo_documento, num_documento, status, dt_nascimento, dt_cadastro)VALUES('0123464','caco79','carlos1979','Carlos Augusto Moraes','caco@caco.com','CPF',00134123561,'Ativo','2003-06-06','2023-05-01')''')
