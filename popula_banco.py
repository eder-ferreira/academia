...
with con:
    cur.execute('''INSERT INTO tb_usuario(matricula,usuario, senha, nome, email, tipo_documento, num_documento, status, dt_nascimento, dt_cadastro)VALUES('0123456','admrural','adm123','Eder Ferreira','admrural@gmail.com','RG','001036771','Ativo','1979-09-25','2023-01-02')''')
    cur.execute('''INSERT INTO tb_usuario(matricula,usuario, senha, nome, email, tipo_documento, num_documento, status, dt_nascimento, dt_cadastro)VALUES('0123457','loren','loren','Loren Pires','loren@loren.com','CPF',00134123456,'Inativo','2007-01-24','2023-02-02')''')
    cur.execute('''INSERT INTO tb_usuario(matricula,usuario, senha, nome, email, tipo_documento, num_documento, status, dt_nascimento, dt_cadastro)VALUES('0123458','jleonel','admin','João Leonel Ferreira','jleonel@gmail.com','CPF',00134123457,'Ativo','1980-04-02','2023-03-02')''')
    cur.execute('''INSERT INTO tb_usuario(matricula,usuario, senha, nome, email, tipo_documento, num_documento, status, dt_nascimento, dt_cadastro)VALUES('0123459','luisinha','anapires','Ana Luisa Pires','ana.luisa@ana.com',' RG',001036556,'Ativo','1987-04-04','2023-04-02')''')
    cur.execute('''INSERT INTO tb_usuario(matricula,usuario, senha, nome, email, tipo_documento, num_documento, status, dt_nascimento, dt_cadastro)VALUES('0123460','luvpof','lu123','Luciana Ferreira','lu@gmail.com','CPF',00103655632,'Ativo','1979-09-25','2023-05-02')''')
    cur.execute('''INSERT INTO tb_usuario(matricula,usuario, senha, nome, email, tipo_documento, num_documento, status, dt_nascimento, dt_cadastro)VALUES('0123461','aurora','au3355','Maria Aurora da Silva','aurora@aurora.com','CPF',00134123459,'Ativo','2002-03-17','2023-01-02')''')
    cur.execute('''INSERT INTO tb_usuario(matricula,usuario, senha, nome, email, tipo_documento, num_documento, status, dt_nascimento, dt_cadastro)VALUES('0123462','alice2005','al2023','Alice Ortega','ortega@alice.com','RG',001022987,'Ativo','1988-01-20','2023-02-02')''')
    cur.execute('''INSERT INTO tb_usuario(matricula,usuario, senha, nome, email, tipo_documento, num_documento, status, dt_nascimento, dt_cadastro)VALUES('0123463','toniamachado','272ton','Antonia Machado','tonia@gmail.com','CPF',00134123460,'Inativo','2001-12-05','2023-07-02')''')
    cur.execute('''INSERT INTO tb_usuario(matricula,usuario, senha, nome, email, tipo_documento, num_documento, status, dt_nascimento, dt_cadastro)VALUES('0123464','caco79','carlos1979','Carlos Augusto Moraes','caco@caco.com','CPF',00134123561,'Ativo','2003-06-06','2023-07-02')''')
    cur.execute('''INSERT INTO tb_usuario(matricula,usuario, senha, nome, email, tipo_documento, num_documento, status, dt_nascimento, dt_cadastro)VALUES('0123465','arimateia','ari68','José de Arimateia','arimateia@gmail.com','Passaport',33097512,'Ativo','1978-12-25','2023-01-02')''')
    con.commit()
print("Tabela de Usuarios populada com sucesso!")

# ----------------------  POPULA TABELA ALUNOS ------------------------------
with con:
    cur.execute('''INSERT INTO tb_aluno(matricula, nome, tipo_documento, num_documento, telefone, genero, status, dt_cadastro, dt_nascimento)VALUES('0123456','Eder Ferreira','RG',001036771,'6799996-1792','M','Ativo','2023-01-02','1979-09-25')''')
    cur.execute('''INSERT INTO tb_aluno(matricula, nome, tipo_documento, num_documento, telefone, genero, status, dt_cadastro, dt_nascimento)VALUES('0123457','Loren Pires','CPF',00134123456,'6899996-1722','M','Ativo','2023-02-02','2007-01-24')''')
    cur.execute('''INSERT INTO tb_aluno(matricula, nome, tipo_documento, num_documento, telefone, genero, status, dt_cadastro, dt_nascimento)VALUES('0123458','João Leonel Ferreira','CPF',00134123457,'6999996-1800','F','Ativo','2023-03-02','1980-04-02')''')
    cur.execute('''INSERT INTO tb_aluno(matricula, nome, tipo_documento, num_documento, telefone, genero, status, dt_cadastro, dt_nascimento)VALUES('0123459','Ana Luisa Pires','RG',001036556,'1199996-1733','M','Ativo','2023-04-02','1987-04-04')''')
    cur.execute('''INSERT INTO tb_aluno(matricula, nome, tipo_documento, num_documento, telefone, genero, status, dt_cadastro, dt_nascimento)VALUES('0123460','Luciana Ferreira','CPF',00103655632,'6699996-1392','M','Ativo','2023-05-02','1979-09-25')''')
    cur.execute('''INSERT INTO tb_aluno(matricula, nome, tipo_documento, num_documento, telefone, genero, status, dt_cadastro, dt_nascimento)VALUES('0123461','Maria Aurora da Silva','CPF',00134123459,'6599996-1295','F','Ativo','2023-01-02','2002-03-17')''')
    cur.execute('''INSERT INTO tb_aluno(matricula, nome, tipo_documento, num_documento, telefone, genero, status, dt_cadastro, dt_nascimento)VALUES('0123462','Alice Ortega','RG',001022987,'2199996-1891','M','Ativo','2023-02-02','1988-01-20')''')
    cur.execute('''INSERT INTO tb_aluno(matricula, nome, tipo_documento, num_documento, telefone, genero, status, dt_cadastro, dt_nascimento)VALUES('0123463','Antonia Machado','CPF',00134123460,'4499996-1202','F','Ativo','2023-07-02','2001-12-05')''')
    cur.execute('''INSERT INTO tb_aluno(matricula, nome, tipo_documento, num_documento, telefone, genero, status, dt_cadastro, dt_nascimento)VALUES('0123464','Carlos Augusto Moraes','CPF',00134123561,'6299996-1112','F','Ativo','2023-07-02','2003-06-06')''')
    cur.execute('''INSERT INTO tb_aluno(matricula, nome, tipo_documento, num_documento, telefone, genero, status, dt_cadastro, dt_nascimento)VALUES('0123465','José de Arimateia','Passaport',33097512,'6799996-0093','F','Ativo','2023-01-02','1978-12-25')''')
    con.commit()
